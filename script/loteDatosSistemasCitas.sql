...
(10, 'Chequeo pulmonar', '2024-11-18'), (11, 'Evaluación ortopédica', '2024-11-19');
...
('99887766', 'Miguel', 'Sanchez', '1994-04-10', 'miguel.sanchez@example.com', '376-9988776', 30, '3300', 10);
...
(7, 'medico_4', 'clave123', 'activo', 3, 99887766);
...
(6, 'Terapia analgésica', 'Alivio de dolor crónico', 10);

INSERT INTO Cita (Id_Cita, Fecha, Motivo, NroMatricula, NroPaciente, NroDocumento) VALUES
(1, '2024-11-10', 'Chequeo general', 1, 1, '12345678'), 
(2, '2024-11-11', 'Control de presión', 2, 2, '87654321'),
(3, '2024-11-12', 'Consulta endocrinológica', 5, 3, 11223344), 
(4, '2024-11-13', 'Consulta oncológica', 4, 4, 33445566),
